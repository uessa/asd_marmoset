...
class NetworkCNN(nn.Module):
    def __init__(self):
        ...
        self.net = nn.Sequential(
            nn.Conv2d(
                ch_in, ch_1, kernel_size=7, stride=1, padding=3, dilation=1
            ),
            nn.MaxPool2d(
            ...
            nn.BatchNorm2d(ch_1),
            nn.Conv2d(
                ch_1, ch_2, kernel_size=7, stride=1, padding=6, dilation=2
            ),
            nn.MaxPool2d(
                kernel_size=5, stride=(5, 1), padding=(0, 2), dilation=1, ceil_mode=True
            ),
            ...
            nn.BatchNorm2d(ch_2),
            nn.Conv2d(
                ch_2, ch_3, kernel_size=7, stride=1, padding=9, dilation=3
            ),
            nn.MaxPool2d(
                kernel_size=5, stride=(5, 1), padding=(0, 2), dilation=1, ceil_mode=True
            ),
            ...
            nn.BatchNorm2d(ch_3),
            nn.Conv2d(
                ch_3, ch_4, kernel_size=7, stride=1, padding=12, dilation=4
            ),
            nn.MaxPool2d(
            ...
            nn.BatchNorm2d(ch_4),
            nn.Conv2d(
                ch_4, ch_out, kernel_size=7, stride=1, padding=3, dilation=1
            ),
