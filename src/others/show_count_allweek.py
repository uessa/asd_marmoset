...
if __name__ == "__main__":
    ...
    labelpath = "/home/muesaka/projects/marmoset/datasets/subset_marmoset_23ue/test_tested/"
    resultpath = "/home/muesaka/projects/marmoset/datasets/subset_marmoset_23ue/test_tested/results/"
    ...
    if is_plot: 
        ...
        for fname in tests:
            for lname in lnames:
                ...
                plt.bar(week-0.2/2, count_label, label="G.T.", width=0.2) #左側(-)に棒グラフ
                plt.bar(week+0.2/2, count_results,label="Est.", width=0.2) #右側(+)に棒グラフ
